...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2022 a las 23:28:35
...
(1, 'odootest', 'publicaciones', 'imagen', '', 'image_jpeg', '', '', '', '');
...
('root', '[{\"db\":\"odootest\",\"table\":\"usuarios\"},{\"db\":\"odootest\",\"table\":\"publicaciones\"}]');
...
('root', 'odootest', 'publicaciones', '{\"CREATE_TIME\":\"2022-11-10 11:48:58\",\"col_order\":[0,2,1,3],\"col_visib\":[1,1,1,1]}', '2022-11-12 18:24:00');
...
('root', '2022-11-18 19:37:32', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":396}');
...
CREATE TABLE `publicaciones` (
  ...
  `lugar` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `publicaciones` (`id`, `contenido`, `imagen`, `lugar`, `provincia`) VALUES
(7, 'Refugio de montaña que se encuentra luego de un trekking de 26km. En el Maollin ahogado, El Bolsón.', './assets/losLaguitos.jpg', 'Los Laguitos', 'Rio Negro'),
(8, 'Hermoso parque, en la capital mundial del trekking, lleno de senderos para recorrer la inmensidad de la Cordillera de los Andes.', './assets/chalten.jpg', 'Los Glaciares', 'Santa Cruz'),
(9, 'Hermoso refugio de montaña, ubicado en el Maollín ahogado, en El bolsón.\r\nPara llegar se debe realizar un trekking de montaña de aproximadamente 16km.', './assets/refugio-hielo-azul-el-bolson-2.jpg', 'Hielo Azul', 'Rio Negro'),
(10, 'Aunque parezca una imágen tomada por la Nasa, es en Argentina, un hermoso lugar que parece de otro planeta. ', './assets/valleDeLaLuna.jpg', 'Valle de la Luna', 'San Juan'),
(12, 'Un maravilloso lugar a tan solo 4km del Aconcágua. Solo se puede encotnrar un paisaje así a más de 4000m snm.\r\nExcelente ubicación para realizar trekking rodeado de nieve, en la inponente Cordillera de los Andes.', './assets/penitentes.jpg', 'Penitentes', 'Mendoza'),
(13, 'Está ubicado a orillas de la laguna Toncek, de aguas verdes y frías, al pie de la aguja Frey del cerro Catedral. Debe su nombre al ingeniero Emilio Frey, quien desde 1895 estuvo vinculado a la zona cordillerana como integrante de la Comisión de Límites, presidida por el Perito Moreno. También fue intendente del parque nacional Nahuel Huapi y uno de los fundadores del Club Andino Bariloche.', './assets/frey.jpg', 'Refugio Frey', 'Rio Negro'),
(14, 'La Laguna Esmeralda se encuentra en el Valle Tierra Mayor, junto al cerro Bonete en la Sierra Alvear, a solo 20 km de Ushuaia por la ruta 3.\r\nEs un lugar realmente increíble, cuyo color hace honor a su nombre.\r\nLos bosques, montañas y glaciar que la rodean la convierten en un lugar digno de ser visitado.\r\nLlegamos hasta la laguna atravesando bosques y turbales.\r\nEsta laguna de infinita belleza se encuentra enclavada entre montañas.', './assets/esmeralda.jpg', 'Laguna Esmeralda', 'Tierra del Fuego');
